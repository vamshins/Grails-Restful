    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="postalCode"
                              title="${message(code: 'city.postalCode.label', default: 'Postal Code')}"/>

            <g:sortableColumn property="cityName"
                              title="${message(code: 'city.cityName.label', default: 'City Name')}"/>

            <g:sortableColumn property="countryCode"
                              title="${message(code: 'city.countryCode.label', default: 'Country Code')}"/>

            <g:sortableColumn property="dateCreated"
                              title="${message(code: 'city.dateCreated.label', default: 'Date Created')}"/>
        ...
        <g:each in="${cityInstanceList}" status="i" var="cityInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${cityInstance.id}">${fieldValue(bean: cityInstance, field: "postalCode")}</g:link></td>
